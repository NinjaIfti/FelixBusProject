...
<body class="bg-gray-900 text-gray-100 min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-4 py-8 flex-1">
        ...
        <div class="mb-6">
            ...
            <?php elseif($_SESSION['user_type'] === 'staff' || $_SESSION['user_type'] === 'admin'): ?>
                <a href="admin_painel.php" class="text-red-500 hover:text-red-400">
                    <i class="fas fa-arrow-left mr-1"></i> Back to Dashboard
                </a>
            <?php endif; ?>
        </div>
            ...
            <div class="md:col-span-1">
                <div class="bg-gray-800 p-6 rounded-lg shadow-md mb-6 card border border-gray-700">
                    ...
                    <div class="border-t border-gray-700 pt-4">
                        ...
                        <?php if($_SESSION['user_type'] === 'client'): ?>
                            <div class="mt-4">
                                <a href="cliente_carteira.php" class="text-red-500 hover:text-red-400 text-sm font-medium">
                                    <i class="fas fa-wallet mr-1"></i> Manage Wallet
                                </a>
                            </div>
                            <div class="mt-2">
                                <a href="cliente_bilhetes.php" class="text-red-500 hover:text-red-400 text-sm font-medium">
