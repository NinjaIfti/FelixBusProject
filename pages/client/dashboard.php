    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="text-3xl font-bold text-gray-800">$<?php echo number_format($wallet['balance'], 2); ?></p>
                <div class="mt-4">
                    <a href="wallet.php" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Manage Wallet <i class="fas fa-arrow-right ml-1"></i></a>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                ?>
                <p class="text-3xl font-bold text-gray-800"><?php echo $active_tickets['total']; ?></p>
                <div class="mt-4">
                    <a href="tickets.php" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View Tickets <i class="fas fa-arrow-right ml-1"></i></a>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-xl font-semibold text-gray-800">Account Info</h2>
                    <span class="text-blue-600 text-2xl">
                        <i class="fas fa-user-circle"></i>
                    </span>
                </div>
                <p class="text-gray-600 mb-1">Email: <?php echo htmlspecialchars($user['email']); ?></p>
                <p class="text-gray-600">Member since: <?php echo date('F Y', strtotime($user['created_at'])); ?></p>
                <div class="mt-4">
                    <a href="../profile.php" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Edit Profile <i class="fas fa-arrow-right ml-1"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <?php while($ticket = $tickets_result->fetch_assoc()): ?>
                            <div class="border-b pb-4">
                                <div class="flex justify-between">
                                    <div>
                                        <h3 class="font-semibold text-gray-800"><?php echo htmlspecialchars($ticket['origin']); ?> to <?php echo htmlspecialchars($ticket['destination']); ?></h3>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Ticket #<?php echo htmlspecialchars($ticket['ticket_number']); ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php endwhile; ?>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="wallet.php" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View All</a>
                </div>
                                ...
                                <div class="flex justify-between">
                                    <div>
                                        <h3 class="font-semibold text-gray-800">
                                            <?php
                                                echo $transaction['transaction_type'] === 'deposit' ? 'Wallet Deposit' : 
                                                    ($transaction['transaction_type'] === 'withdrawal' ? 'Wallet Withdrawal' : 
                                                    ($transaction['transaction_type'] === 'purchase' ? 'Ticket Purchase' : 'Refund'));
                                            ?>
                                        </h3>
                                        <p class="text-sm text-gray-600">
                                            Date: <?php echo date('F j, Y', strtotime($transaction['created_at'])); ?><br>
        ...
        <div class="mt-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="../routes.php" class="bg-white p-4 rounded-lg shadow-md text-center hover:bg-blue-50">
                    <div class="text-blue-600 text-3xl mb-2">
                        <i class="fas fa-search"></i>
                    </div>
                    <p class="font-medium text-gray-800">Find Routes</p>
                </a>
                <a href="tickets.php" class="bg-white p-4 rounded-lg shadow-md text-center hover:bg-blue-50">
                    <div class="text-blue-600 text-3xl mb-2">
                        <i class="fas fa-ticket-alt"></i>
                    </div>
                    <p class="font-medium text-gray-800">My Tickets</p>
                </a>
                <a href="wallet.php" class="bg-white p-4 rounded-lg shadow-md text-center hover:bg-blue-50">
                    <div class="text-blue-600 text-3xl mb-2">
                        <i class="fas fa-wallet"></i>
                    </div>
                    <p class="font-medium text-gray-800">Add Funds</p>
                </a>
                <a href="../profile.php" class="bg-white p-4 rounded-lg shadow-md text-center hover:bg-blue-50">
                    <div class="text-blue-600 text-3xl mb-2">
