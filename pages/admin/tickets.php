    ...
    <div class="flex flex-1">
        <div class="bg-black text-white w-64 py-6 flex-shrink-0 hidden md:block">
            ...
            <nav class="mt-10">
                ...
                <a href="tickets.php" class="flex items-center py-3 px-6 bg-red-900 text-white nav-link">
        ...
        <div class="flex-1 overflow-x-hidden overflow-y-auto">
            ...
            <main class="container mx-auto px-4 py-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div>
                        <a href="../routes.php" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg inline-flex items-center">
