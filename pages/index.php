            ...
            <div class="container mx-auto px-4 h-full flex items-center relative z-10">
                <div class="text-white max-w-2xl">
                    ...
                    <div class="flex space-x-4">
                        <a href="rotas.php" class="bg-red-600 text-white px-6 py-3 rounded-md font-medium hover:bg-red-700 transition duration-300 btn-primary">
                            Explore Routes
                        </a>
                        <a href="registar.php" class="bg-transparent border-2 border-white text-white px-6 py-3 rounded-md font-medium hover:border-red-600 hover:text-red-600 transition duration-300">
                            Join Now
                        </a>
                    </div>
                </div>
